...
<section id="about" class="px-12 py-16 text-center md:px-32">
...
<section id="fitur-utama" class="py-16 text-center md:px-40">
    <h2 class="px-12 mb-12 text-3xl font-bold tracking-widest">Fitur Utama FinFinder</h2>
    <ol class="text-xl [word-spacing:15px] text-justify list-decimal px-20">
