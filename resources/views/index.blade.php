    ...
    <section id="hero" class="-z-[999] relative h-screen bg-[url(/public/img/bg.svg)] bg-cover bg-left-bottom shadow-xl">
        <div
            ...
            <div class="w-full mx-4 lg:w-1/2">
                <img src="{{ asset('img/hero/img.svg') }}" alt="img-hero"
    ...
    <section id="tentang-kami" class="pt-32 pb-16 bg-sky-50 lg:px-12">
        <div class="flex flex-wrap items-center justify-center gap-6 px-6 lg:px-28 lg:flex-nowrap">
            <div class="w-full lg:w-1/2 lg:mr-14" id="img-tentang-kami">
                <div class="w-full h-[600px] bg-[url('/public/img/about/img.jpg')] bg-cover bg-center rounded-xl shadow-xl">
                </div>
                {{-- <img src="{{ asset('img/about/img.jpg') }}" alt="raja-ampat" class=" h-[600px] shadow-xl" loading="lazy"> --}}
            </div>
    ...
    <section id="timeline" class="pt-32 pb-16 bg-sky-50 lg:px-32">
        ...
        <div
            ...
            <x-card-timeline :isRight="false" img="user.svg" judul="Register FinFinder">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aliquam, eum minima! Exercitationem est
                deserunt sequi!
            </x-card-timeline>
            <x-card-timeline :isRight="true" img="upload.svg" judul="Tambah Data">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus beatae, est inventore impedit illum
                cum!
            </x-card-timeline>
            <x-card-timeline :isRight="false" img="verified.svg" judul="Verifasi Data">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima, ipsam! Voluptates, modi. Perspiciatis,
                vero exercitationem.
            </x-card-timeline>
            <x-card-timeline :isRight="true" img="map.svg" judul="Jelajahi Data">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur rerum velit earum temporibus! Fugiat,
                consectetur!
            </x-card-timeline>
        ...
        <div class="flex flex-wrap justify-center gap-8 lg:flex-nowrap lg:justify-normal">
            ...
            <div class="flex flex-col items-center justify-center w-full p-8 rounded-lg md:w-1/3 bg-sky-50 ">
                ...
                <div class="mt-8 text-center">
                    <h4 class="mb-4 text-xl font-bold">Peta Interaktif</h4>
                    <p>Temukan titik potensial penangkapan ikan dengan mudah</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-center w-full p-8 rounded-lg md:w-1/3 bg-sky-50 ">
                ...
                <div class="mt-8 text-center">
                    <h4 class="mb-4 text-xl font-bold">Data Terverifikasi</h4>
                    <p>Data sudah terverifikasi oleh admin</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-center w-full p-8 rounded-lg md:w-1/3 bg-sky-50 ">
                ...
                <div class="mt-8 text-center">
                    <h4 class="mb-4 text-xl font-bold">Mudah Digunakan</h4>
                    <p>Gratis dan simpel digunakan untuk semua nelayan</p>
                </div>
            </div>
