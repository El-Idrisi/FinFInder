...
<body class="relative font-inter -z-[9999] overflow-x-hidden bg-sky-50">
    ...
    <aside id="sidebar"
        class="-translate-x-full lg:translate-x-0 h-full w-[240px] bg-white transition-all duration-300 fixed top-0 bottom-0 shadow-lg">
    ...
    <div class="content-shifted lg:ml-[240px]" id="content">
        <header class="flex justify-between w-full gap-12 px-8 text-lg bg-white shadow-lg h-fit">
            ...
            <div class="relative flex">
                ...
                <div
                    class="absolute flex flex-col overflow-hidden text-lg transition-all duration-300 bg-white top-[4.7rem] accordion-content shadow-lg rounded-b-lg">
