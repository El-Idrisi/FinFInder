        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="space-y-6 lg:col-span-1">
                ...
                <div class="p-6 bg-white rounded-lg shadow-md">
                    <h2 class="mb-4 text-lg font-semibold">Informasi Input</h2>

                    <div class="">
                        <!-- Diinput Oleh -->
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-600">Diinput Oleh</label>
                            <div class="flex items-center gap-2 p-3 transition-all duration-300 rounded-lg bg-gray-50 hover:bg-gray-100">
                        ...
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-600">{{ ucfirst($spotIkan->status) }} Oleh</label>
                            <div class="flex items-center gap-2 p-3 transition-all duration-300 rounded-lg bg-gray-50 hover:bg-gray-100">
                                <i class="text-sky-500 fas fa-user"></i>
                ...
                <!-- Fish Types Card -->
                <div class="p-6 bg-white rounded-lg shadow-md">
                    <h2 class="mb-4 text-lg font-semibold">Jenis Ikan</h2>
                    <div class="flex flex-wrap gap-2">
                        @foreach ($spotIkan->getFishTypes() as $ikan)
                            <span class="px-3 py-1.5 text-sm font-medium transition-colors duration-300 border rounded-lg border-sky-200 text-sky-700 hover:bg-sky-50">
                                {{ $ikan->nama }}
                            </span>
                        @endforeach
                    </div>
            ...
            <div class="lg:col-span-2">
                <div class="h-full p-6 bg-white rounded-lg shadow-md">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="p-2 text-sm bg-gray-100 rounded-lg">
                            <span class="font-mono">{{ $spotIkan->latitude }}, {{ $spotIkan->longitude }}</span>
                        </div>
                    </div>

                    <div class="w-full h-[600px] lg:h-[calc(100%-55px)] overflow-hidden rounded-lg">
            ...
            <div class="lg:col-span-3">
                <div class="p-6 bg-white rounded-lg shadow-md">
                    <h2 class="mb-4 text-lg font-semibold">Deskripsi</h2>
