<div class="overflow-hidden bg-white rounded-lg shadow-lg tilt" style="transform-style: preserve-3d;">
    ...
    {{-- Card Body dengan Flex untuk Posisi Tombol --}}
    <div class="flex flex-col h-[calc(100%-12rem)]"> {{-- Kurangi tinggi map (12rem = 48px) --}}
        ...
        {{-- Action Buttons Container (Selalu di Bawah) --}}
        <div class="p-4 pt-0">
            {{-- View Button --}}
